...
public class Lab_7 {
	...
	static void replayScan(String page) {
		...
		for (int i = 0; i < 1; i++) {
			// System.out.println("PEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEETLA " +
			// (i + 1));
			Copy.addAll(Main);
			for (String ref : Copy) {
				temp = ref;
			...
			// System.out.println("Petla:AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA " + (i
			// + 1));
		}
	...
	public static void SaveTxt(String adres) throws IOException {
		...
		// FileWriter("C:\\Users\\HP\\Desktop\\SemWeb\\lab1\\Wiki"+Counter+".html");
		...
		// FileReader("C:\\Users\\HP\\Desktop\\SemWeb\\lab1\\Wiki"+Counter+".html");

		List<String> patternList = Arrays.asList("\\,", "\\.", "\\!", "\\?", "\\(", "\\)", "\\-", "\\<", "\\>", "\\t+",
				"\\:");

		// File file = new
		// File("C:\\Users\\HP\\Desktop\\SemWeb\\lab1\\Wiki"+Counter+".txt");
	...
	// przelaruje po plikach, wyszukeju zipy i pobiera z nich zawartosc,
	// wykorzystujac ponizej zaimplementowane funkcjie
